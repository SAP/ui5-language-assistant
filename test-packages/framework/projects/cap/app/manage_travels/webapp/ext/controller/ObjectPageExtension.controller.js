sap.ui.define(
  ...
  function (ControllerExtension) {
    ...
    return ControllerExtension.extend(
      "sap.fe.demo.managetravels.ext.controller.ObjectPageExtension",
      {
        ...
        override: {
           ...
           * @memberOf sap.fe.demo.managetravels.ext.controller.ObjectPageExtension
           */
          onInit: function () {
              ...
              if (!this.getView().getBindingContext().getProperty("GoGreen")) {
                return new Promise(
                  async function (fnResolve, fnReject) {
                    var mSettings = {
                      id: "myFragment",
                      name: "sap.fe.demo.managetravels.ext.fragment.Trees4Tickets",
