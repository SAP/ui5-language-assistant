...
describe("the UI5 language assistant Hover Tooltip Service", () => {
  ...
  describe("hover on attribute key", () => {
    it("will get hover content UI5 property", () => {
      ...
      expect(ui5Node.name).toEqual("showSeparators");
      expect(ui5Node.kind).toBe("UI5Prop");
    });
  ...
  describe("hover on attribute value", () => {
    it("will get hover content UI5 enum", () => {
      ...
      const ui5Node = getUI5Node(xmlSnippet, appContext);
      expectExists(ui5Node, "UI5Node");
      expect(ui5Node.name).toEqual("All");
      expect(ui5Node.kind).toBe("UI5EnumValue");
    });
    ...
    it("will get hover content UI5 namespace", () => {
      ...
      const ui5Node = getUI5Node(xmlSnippet, appContext);
      expectExists(ui5Node, "UI5Node");
      expect(ui5Node.name).toEqual("m");
      expect(ui5Node.kind).toBe("UI5Namespace");
    });
  });
  ...
  describe("hover on element open tag name", () => {
    it("will get hover content UI5 class", () => {
      ...
      const ui5Node = getUI5Node(xmlSnippet, appContext);
      expectExists(ui5Node, "UI5Node");
      expect(ui5Node.name).toEqual("List");
      expect(ui5Node.kind).toBe("UI5Class");
    });
    ...
    it("will get hover content UI5 Aggregation", () => {
      ...
      const ui5Node = getUI5Node(xmlSnippet, appContext);
      expectExists(ui5Node, "UI5Node");
      expect(ui5Node.name).toEqual("content");
      expect(ui5Node.kind).toBe("UI5Aggregation");
    });
  ...
  describe("hover on element close tag name", () => {
    ...
    it("will get hover content UI5 class with default namespace", () => {
      ...
      const ui5Node = getUI5Node(xmlSnippet, appContext);
      expectExists(ui5Node, "UI5Node");
      expect(ui5Node.name).toEqual("Button");
      expect(ui5Node.kind).toBe("UI5Class");
    });
