...
- bb43dd2: fix: upgrade lerna and CI/CD to use node version 20 and 22
  - @ui5-language-assistant/language-server@4.0.66
...
- Updated dependencies [d7f5b66]
  - @ui5-language-assistant/language-server@4.0.65
...
- 870d01a: fix: update manifest cache after reading new manifest
  - @ui5-language-assistant/language-server@4.0.64
...
- 6f5945b: fix: do not show vSorterInfo as completion item and show correct diagnostic
  - @ui5-language-assistant/language-server@4.0.61
...
- Updated dependencies [360deaa]
  - @ui5-language-assistant/language-server@4.0.40
...
- Updated dependencies [ccd5eae]
  - @ui5-language-assistant/language-server@4.0.37
