...
annotate my.Booking {
  ...
  ConnectionID @Common.ValueList: {
    ...
    Parameters : [
      ...
      {$Type: 'Common.ValueListParameterOut', LocalDataProperty: ConnectionID, ValueListProperty: 'ConnectionID'},      
      {$Type: 'Common.ValueListParameterOut', LocalDataProperty: to_Carrier_AirlineID,    ValueListProperty: 'AirlineID'},      
