  ...
  symbols: [
    ...
    },
    {
      ...
      "ui5-metadata": {
        ...
        properties: [
          ...
          },
          {
            ...
            methods: ["getLineNumbers", "setLineNumbers"]
          },
          {
            name: "valueSelection",
            type: "boolean",
            ...
            methods: ["getValueSelection", "setValueSelection"]
          },
          {
            name: "maxLines",
            type: "int",
            ...
            methods: ["getMaxLines", "setMaxLines"]
          },
          {
            name: "colorTheme",
            type: "string",
            ...
            methods: ["getColorTheme", "setColorTheme"]
          },
          {
            name: "syntaxHints",
            type: "boolean",
            ...
            methods: ["getSyntaxHints", "setSyntaxHints"]
          }
        ],
        ...
        events: [
          {
            ...
            parameters: {
              value: {
                name: "value",
                type: "string",
                description: "The current value of the code editor."
              },
              editorEvent: {
                name: "editorEvent",
                type: "object",
          ...
          },
          {
            ...
            parameters: {
              ...
              oldValue: {
                name: "oldValue",
                type: "string",
                description: "The old value of the code editor."
              }
            },
      ...
      methods: [
        ...
        {
          name: "addCustomCompleter",
          visibility: "public",
          since: "1.52",
          parameters: [
            {
              name: "oCustomCompleter",
              type: "object",
              optional: false,
              description: "Object with getCompletions method"
            }
          ],
          description:
        ...
        },
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              optional: true,
              description:
                "Context object to call the event handler with. Defaults to this <code>sap.ui.codeeditor.CodeEditor</code> itself"
            }
          ],
          description:
        ...
        },
        {
          ...
          returnValue: {
            type: "int",
            description: "Value of property <code>maxLines</code>"
          },
          description:
        ...
        },
        {
          ...
          visibility: "public",
          since: "1.54.1",
          description: "Pretty-prints the content of the editor"
        },
        {
          name: "setColorTheme",
          visibility: "public",
          ...
          parameters: [
            {
              ...
              type: "string",
              optional: false,
              description: "See property documentation for accepted values"
            }
          ],
          ...
          parameters: [
            {
              ...
              type: "int",
              optional: false,
              description: "Maximum number of lines the editor should display"
            }
          ],
          description: "Sets <code>maxLines</code> property."
        },
        {
          name: "setSyntaxHints",
          visibility: "public",
          ...
          parameters: [
            {
              ...
              type: "boolean",
              optional: false,
              description: "Whether the code editor is visible."
            }
          ],
          description: "Sets <code>visible</code> property."
        },
        {
          name: "setWidth",
          visibility: "public",
