...
export const api: LibraryFile = {
  ...
  symbols: [
    ...
    },
    {
      ...
      methods: [
        ...
        },
        {
          ...
          returnValue: {
            type: "sap.ui.layout.BlockLayoutCell",
            description: "this BlockLayoutCell reference for chaining."
          },
          parameters: [
            {
              name: "iWidth",
    ...
    },
    {
      ...
      properties: [
        ...
        },
        {
          ...
          static: true,
          type: "string",
          description: "Shade E - available only for Fiori 3 theme"
        },
        {
          name: "ShadeF",
          visibility: "public",
          static: true,
          type: "string",
          description: "Shade F - available only for Fiori 3 theme"
        }
      ]
    },
    {
    ...
    {
      kind: "namespace",
      name: "sap.ui.layout.BoxesPerRowConfig",
      basename: "BoxesPerRowConfig",
      resource: "sap/ui/layout/library.js",
      module: "sap/ui/layout/library",
      export: "BoxesPerRowConfig",
      final: true,
      static: true,
      visibility: "public",
      since: "1.61.0",
      ...
      examples: [
        {
          text: "<code>XL7 L6 M4 S2</code>"
        },
        {
          text: "<code>XL12 L12 M12 S1</code>"
        }
      ],
      "ui5-metamodel": true,
      "ui5-metadata": {
    ...
    {
      kind: "namespace",
      name: "sap.ui.layout.cssgrid.CSSGridGapShortHand",
      basename: "CSSGridGapShortHand",
      resource: "sap/ui/layout/library.js",
      module: "sap/ui/layout/library",
      export: "cssgrid.CSSGridGapShortHand",
      final: true,
      static: true,
      visibility: "public",
      since: "1.60.0",
      description: "A string type that represents a short hand CSS grid gap.",
      references: [
    ...
    {
      kind: "namespace",
      name: "sap.ui.layout.cssgrid.CSSGridLine",
      basename: "CSSGridLine",
      resource: "sap/ui/layout/library.js",
      module: "sap/ui/layout/library",
      export: "cssgrid.CSSGridLine",
      final: true,
      static: true,
      visibility: "public",
      since: "1.60.0",
    ...
    {
      kind: "namespace",
      name: "sap.ui.layout.cssgrid.CSSGridTrack",
      basename: "CSSGridTrack",
      resource: "sap/ui/layout/library.js",
      module: "sap/ui/layout/library",
      export: "cssgrid.CSSGridTrack",
      final: true,
      static: true,
      visibility: "public",
      since: "1.60.0",
    ...
    {
      kind: "class",
      name: "sap.ui.layout.cssgrid.GridBasicLayout",
      basename: "GridBasicLayout",
      resource: "sap/ui/layout/cssgrid/GridBasicLayout.js",
      module: "sap/ui/layout/cssgrid/GridBasicLayout",
      export: "",
      static: true,
      visibility: "public",
      since: "1.60",
      ...
      methods: [
        ...
        },
        {
          ...
          visibility: "public",
          returnValue: {
            type: "sap.ui.layout.cssgrid.GridBasicLayout",
            description:
              "Reference to <code>this</code> in order to allow method chaining"
          },
          parameters: [
    ...
    {
      kind: "class",
      name: "sap.ui.layout.cssgrid.GridBoxLayout",
      basename: "GridBoxLayout",
      resource: "sap/ui/layout/cssgrid/GridBoxLayout.js",
        ...
        properties: [
          {
            ...
            group: "Misc",
            visibility: "public",
            description: "Defines the minimum width of the Boxes",
            methods: ["getBoxMinWidth", "setBoxMinWidth"]
          },
          {
            name: "boxWidth",
            type: "sap.ui.core.CSSSize",
            ...
            group: "Misc",
            visibility: "public",
            description: "Defines the width of the Boxes",
            methods: ["getBoxWidth", "setBoxWidth"]
          },
          {
            name: "boxesPerRowConfig",
            type: "sap.ui.layout.BoxesPerRowConfig",
            ...
            methods: ["getBoxesPerRowConfig", "setBoxesPerRowConfig"]
          }
        ]
      },
      constructor: {
      ...
      methods: [
        ...
        {
          name: "_getTemplateColumns",
          visibility: "protected",
          returnValue: {
            type: "string",
            description: "A value for gridTemplateColumns property"
          },
          description:
            "Returns a gridTemplateColumns value based on boxWidth and boxMinWidth properties"
        },
        {
          name: "_polyfillAfterDragEnd",
          visibility: "protected",
          parameters: [
            {
              name: "oEvent",
              type: "Object",
              optional: false,
              description: "After drag end event"
            }
          ],
          description: "Implements polyfill for IE after drag end."
        },
        {
          name: "_polyfillAfterDragOver",
          visibility: "protected",
          parameters: [
            {
              name: "oEvent",
              type: "Object",
              optional: false,
              description: "After drag over event"
            }
          ],
          description: "Implements polyfill for IE after drag over."
        },
        {
          name: "_setGridLayout",
          visibility: "protected",
          parameters: [
            {
              ...
              type: "HTMLElement",
              optional: false,
              description: "The element to which to apply the grid styles"
            },
            {
              name: "oGridSettings",
              type: "sap.ui.layout.cssgrid.GridSettings",
              optional: false,
              description: "The grid settings to apply"
            }
          ],
          description:
        ...
        {
          name: "getBoxesPerRowConfig",
          visibility: "public",
          returnValue: {
            type: "sap.ui.layout.BoxesPerRowConfig",
            description: "Value of property <code>boxesPerRowConfig</code>"
          },
          description:
        ...
        },
        {
          ...
          returnValue: {
            type: "sap.ui.core.CSSSize",
            description: "Value of property <code>boxMinWidth</code>"
          },
          description:
        ...
        },
        {
          ...
          returnValue: {
            type: "sap.ui.core.CSSSize",
            description: "Value of property <code>boxWidth</code>"
          },
          description:
        ...
        {
          name: "setBoxesPerRowConfig",
          visibility: "public",
          returnValue: {
            type: "sap.ui.layout.cssgrid.GridBoxLayout",
            description:
              "Reference to <code>this</code> in order to allow method chaining"
          },
          parameters: [
            {
              name: "sBoxesPerRowConfig",
              type: "sap.ui.layout.BoxesPerRowConfig",
              optional: false,
              description:
                "New value for property <code>boxesPerRowConfig</code>"
            }
          ],
          description:
          ...
          parameters: [
            {
              ...
              type: "sap.ui.core.CSSSize",
              optional: false,
              description: "New value for property <code>boxMinWidth</code>"
            }
          ],
          description:
          ...
          parameters: [
            {
              ...
              type: "sap.ui.core.CSSSize",
              optional: false,
              description: "New value for property <code>boxWidth</code>"
            }
          ],
          description:
    ...
    },
    {
      ...
      methods: [
          ...
          parameters: [
            {
              ...
              type: "HTMLElement",
              optional: false,
              description: "The element from which to remove the grid styles"
            }
          ],
          description:
        ...
        {
          name: "isGridSupportedByBrowser",
          visibility: "public",
          returnValue: {
            type: "boolean",
            description: "If native grid is supported by the browser"
          }
        },
        {
          name: "isResponsive",
    ...
    {
      kind: "class",
      name: "sap.ui.layout.cssgrid.ResponsiveColumnItemLayoutData",
      basename: "ResponsiveColumnItemLayoutData",
      resource: "sap/ui/layout/cssgrid/ResponsiveColumnItemLayoutData.js",
      ...
      methods: [
        ...
        },
        {
          ...
          visibility: "public",
          returnValue: {
            type: "sap.ui.layout.cssgrid.ResponsiveColumnItemLayoutData",
            description:
              "Reference to <code>this</code> in order to allow method chaining"
          },
          parameters: [
    ...
    {
      kind: "class",
      name: "sap.ui.layout.cssgrid.ResponsiveColumnLayout",
      basename: "ResponsiveColumnLayout",
      resource: "sap/ui/layout/cssgrid/ResponsiveColumnLayout.js",
      module: "sap/ui/layout/cssgrid/ResponsiveColumnLayout",
      export: "",
      static: true,
      visibility: "public",
      since: "1.72",
        ...
        events: [
          {
            name: "layoutChange",
            visibility: "public",
            description: "Fired when the currently active layout changes",
            parameters: {
              layout: {
                name: "layout",
                type: "string",
      ...
      methods: [
        {
          ...
          visibility: "public",
          returnValue: {
            type: "sap.ui.layout.cssgrid.ResponsiveColumnLayout",
            description:
              "Reference to <code>this</code> in order to allow method chaining"
          },
          parameters: [
            ...
            },
            {
              ...
              optional: true,
              description:
                "Context object to call the event handler with. Defaults to this <code>sap.ui.layout.cssgrid.ResponsiveColumnLayout</code> itself"
            }
          ],
          description:
        ...
        },
        {
          ...
          description: "Returns if the Grid Layout is responsive."
        }
      ]
    },
    {
      ...
      methods: [
        ...
        },
        {
          ...
          returnValue: {
            type: "boolean",
            description: "Value of property <code>showMainContent</code>"
          },
          description:
        ...
        },
        {
          ...
          returnValue: {
            type: "boolean",
            description: "Value of property <code>showSideContent</code>"
          },
          description:
        ...
        {
          name: "isMainContentVisible",
          visibility: "public",
          returnValue: {
            type: "boolean",
            description: "Main content visibility state"
          },
          description: "Checks if the main content is visible."
        },
        {
          name: "isSideContentVisible",
          visibility: "public",
          returnValue: {
            type: "boolean",
            description: "Side content visibility state"
          },
          description: "Checks if the side content is visible."
        },
        {
      ...
      "ui5-metadata": {
        ...
        properties: [
          ...
          },
          {
            ...
            methods: ["get_editable", "set_editable"]
          }
        ],
        aggregations: [
          {
          ...
          parameters: [
            {
              ...
              type: "boolean",
              optional: false,
              description: "Editable state of the <code>Form</code>"
            }
          ],
          description:
    ...
    },
    {
      ...
      methods: [
        ...
        {
          name: "getFieldsForRendering",
          visibility: "public",
          since: "1.74.0",
          returnValue: {
            type: "sap.ui.core.Control[]",
            description: "Array of fields to be rendered"
          },
          description: "Determines what fields must be rendered."
        },
        {
          name: "getLabel",
          visibility: "public",
    ...
    },
    {
      ...
      deprecated: {
        since: "1.67.0",
        text:
          "as <code>sap.ui.commons</code> library is deprecated and the <code>GridLayout</code> must not be used in responsive applications. Please use <code>ResponsiveGridLayout</code> or <code>ColumnLayout</code> instead."
      },
      "ui5-metamodel": true,
      "ui5-metadata": {
        stereotype: "control",
