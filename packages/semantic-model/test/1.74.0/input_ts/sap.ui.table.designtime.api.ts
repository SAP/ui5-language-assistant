      ...
      methods: [
        ...
        },
        {
          ...
          returnValue: {
            ...
            description:
              "Clone of the template, or <code>null</code> if no template is defined"
          },
          parameters: [
            {
              name: "iIndex",
    ...
    },
    {
      ...
      methods: [
        ...
        },
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              optional: true,
              description:
                "Context object to call the event handler with. Defaults to this <code>sap.ui.table.CreationRow</code> itself"
            }
          ],
          description:
            "Attaches event handler <code>fnFunction</code> to the {@link #event:apply apply} event of this <code>sap.ui.table.CreationRow</code>.\n\nWhen called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, otherwise it will be bound to this <code>sap.ui.table.CreationRow</code> itself.\n\nFired when the corresponding keyboard shortcut or the apply button of the default toolbar are pressed."
        },
        {
          name: "destroyCells",
          visibility: "public",
        ...
        },
        {
          ...
          description:
            "Detaches event handler <code>fnFunction</code> from the {@link #event:apply apply} event of this <code>sap.ui.table.CreationRow</code>.\n\nThe passed function and listener object must match the ones used for event registration."
        },
        {
          name: "extend",
          visibility: "public",
          ...
          description:
            "Creates a new subclass of class sap.ui.table.CreationRow with name <code>sClassName</code> and enriches it with the information contained in <code>oClassInfo</code>.\n\n<code>oClassInfo</code> might contain the same kind of information as described in {@link sap.ui.core.Control.extend}."
        },
        {
          name: "fireApply",
          visibility: "protected",
        ...
        },
        {
          ...
          description:
            "Gets current value of property {@link #getApplyEnabled applyEnabled}.\n\nIf set to <code>false</code>, the {@link #event:apply apply} event is not fired. The corresponding keyboard shortcut and the apply button of the default toolbar are disabled.\n\nDefault value is <code>true</code>."
        },
        {
          name: "getCells",
          visibility: "public",
        ...
        },
        {
          ...
          description:
            "Sets a new value for property {@link #getApplyEnabled applyEnabled}.\n\nIf set to <code>false</code>, the {@link #event:apply apply} event is not fired. The corresponding keyboard shortcut and the apply button of the default toolbar are disabled.\n\nWhen called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.\n\nDefault value is <code>true</code>."
        },
        {
          name: "setToolbar",
          visibility: "public",
        ...
        },
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              optional: true,
              description:
                "Context object to call the event handler with. Defaults to this <code>sap.ui.table.plugins.MultiSelectionPlugin</code> itself"
            }
          ],
          description:
          ...
          parameters: [
            {
              ...
              optional: false,
              description:
                "New value for property <code>enableNotification</code>"
            }
          ],
          description:
          ...
          parameters: [
            {
              ...
              optional: false,
              description:
                "New value for property <code>showHeaderSelector</code>"
            }
          ],
          description:
      ...
      methods: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              optional: true,
              description:
                "Context object to call the event handler with. Defaults to this <code>sap.ui.table.plugins.SelectionPlugin</code> itself"
            }
          ],
          description:
      ...
      methods: [
        {
          ...
          description:
            "Creates a new subclass of class sap.ui.table.rowmodes.AutoRowMode with name <code>sClassName</code> and enriches it with the information contained in <code>oClassInfo</code>.\n\n<code>oClassInfo</code> might contain the same kind of information as described in {@link sap.ui.table.rowmodes.RowMode.extend}."
        },
        {
          ...
          description:
            "Gets current value of property {@link #getHideEmptyRows hideEmptyRows}.\n\nDefault value is <code>false</code>."
        },
        {
          name: "getMaxRowCount",
          visibility: "public",
        ...
        },
        {
          ...
          description:
            "Sets a new value for property {@link #getHideEmptyRows hideEmptyRows}.\n\nWhen called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.\n\nDefault value is <code>false</code>."
        },
        {
          name: "setMaxRowCount",
          visibility: "public",
          ...
          parameters: [
            {
              ...
              optional: false,
              description:
                "New value for property <code>rowContentHeight</code>"
            }
          ],
          description:
      ...
      methods: [
        {
          ...
          description:
            "Creates a new subclass of class sap.ui.table.rowmodes.FixedRowMode with name <code>sClassName</code> and enriches it with the information contained in <code>oClassInfo</code>.\n\n<code>oClassInfo</code> might contain the same kind of information as described in {@link sap.ui.table.rowmodes.RowMode.extend}."
        },
        {
          name: "getHideEmptyRows",
          visibility: "public",
        ...
        },
        {
          ...
          description:
            "Returns a metadata object for class sap.ui.table.rowmodes.FixedRowMode."
        },
        {
          name: "getRowContentHeight",
          visibility: "public",
      ...
      methods: [
        {
          ...
          description:
            "Creates a new subclass of class sap.ui.table.rowmodes.RowMode with name <code>sClassName</code> and enriches it with the information contained in <code>oClassInfo</code>.\n\n<code>oClassInfo</code> might contain the same kind of information as described in {@link sap.ui.core.Element.extend}."
        },
        {
        ...
        },
        {
          ...
          description:
            "Gets the computed row counts. The computed count can differ from the configured count and is the leading number when it comes to managing the rows aggregation of the table and rendering the rows. The sum of <code>scrollable</code>, <code>fixedTop</code> and <code>fixedBottom</code> is equal to <code>count</code>."
        },
        {
        ...
        },
        {
          ...
          description:
            "Gets the CSS styles that are applied to the table's bottom placeholder DOM element. This element can be used to visually reserve space for rows. If <code>undefined</code> is returned during rendering, this element will not be rendered."
        },
        {
          name: "getTableStyles",
          visibility: "protected",
          ...
          parameters: [
            {
              ...
              optional: false,
              description:
                "New value for property <code>fixedTopRowCount</code>"
            }
          ],
          description:
    ...
    },
    {
      ...
      "ui5-metadata": {
        ...
        properties: [
          ...
          },
          {
            ...
            methods: ["getNavigated", "setNavigated"]
          }
        ]
      },
      constructor: {
      ...
      methods: [
        ...
        },
        {
          ...
          returnValue: {
            type: "boolean",
            description: "Value of property <code>navigated</code>"
          },
          description:
          ...
          parameters: [
            {
              ...
              type: "boolean",
              optional: false,
              description: "New value for property <code>navigated</code>"
            }
          ],
          description:
    ...
    },
    {
        ...
        properties: [
          ...
          },
          {
            ...
            deprecated: {
              since: "1.69",
              text:
                "replaced by {@link sap.ui.table.Table#getSelectedIndices} and {@link sap.ui.table.Table#setSelectedIndex}"
            },
        ...
        aggregations: [
          {
            ...
            deprecated: {
              since: "1.72",
              text: "Use the <code>extension</code> aggregation instead."
            },
          ...
          },
          {
            ...
            methods: ["getCreationRow", "destroyCreationRow", "setCreationRow"]
          },
          {
            name: "noData",
            singularName: "noData",
      ...
      methods: [
        ...
        },
        {
          ...
          references: ["sap.ui.table.extensions.Synchronization#getInterface"]
        },
        {
        ...
        },
        {
          ...
          since: "1.52",
          returnValue: {
            description: "sap.ui.core.dnd.DragDropBase[]"
          },
          description:
        ...
        },
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              optional: false,
              description:
                "The <code>0</code>-based index the plugin should be inserted at; for a negative value of <code>iIndex</code>, the plugin is inserted at position 0; for a value greater than the current size of the aggregation, the plugin is inserted at the last position"
            }
          ],
          description:
